...
namespace GazeAwareElements
{
    ...
    public class MainWindowModel : INotifyPropertyChanged
    {
        ...
        {
            Console.WriteLine("MainWindowModel");
        ...
        {
            Console.WriteLine("NotifyInstructionHasGazeChanged");
            if (hasGaze)
            {
        ...
        {
            Console.WriteLine("CloseInstruction");
            ShowInstruction = false;
        }
        ...
        protected void NotifyPropertyChanged(string propertyName)
        {
            ...
            Console.WriteLine("NotifyPropertyChanged");
